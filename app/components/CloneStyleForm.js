...
export default function CloneStyleForm({style: styleData}) {
    const router = useRouter();
    const { userInfo } = useAuth();
    const { buyer, season, style, version, descr, item, status, fabric, prints } = styleData;
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex gap-2">
                        ...
                        >
                            ...
                            <option value={formData?.fabric}>{formData.fabric}</option>
