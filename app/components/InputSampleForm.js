        ...
        <div className="flex justify-between mt-6 items-center">
          {currentStep > 1 && (
            <button
              type="button"
              onClick={handleBack}
              className="bg-gray-300 text-gray-800 px-6 py-2 rounded-lg hover:bg-gray-400 transition-colors shadow-sm"
            >
              Back
            </button>
          )}
          ...
          {currentStep < 4 && (
            <button
              type="button"
              onClick={handleNext}
              className={`bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors shadow-md ${currentStep === 1 ? 'ml-auto' : ''}`}
            >
              Next
            </button>
          )}
